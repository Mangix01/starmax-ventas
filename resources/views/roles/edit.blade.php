              ...
              @if($role->name == $rol2['name'])
                @foreach($rol2['permisos'] as $key2 => $permisito)
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-1">
                      <input type="checkbox" class="dashboard-{{$key2}}" name="dashboard[{{$key2}}]" value="dashboard {{$permiso['tabla']}}" {{ $permiso['dashboard'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="listar-{{$key2}}" name="listar[{{$key2}}]" value="index {{$permiso['tabla']}}" {{ $permiso['listar'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="crear-{{$key2}}" name="crear[{{$key2}}]" value="create {{$permiso['tabla']}}" {{ $permiso['crear'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="editar-{{$key2}}" name="editar[{{$key2}}]" value="edit {{$permiso['tabla']}}" {{ $permiso['editar'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="ver-{{$key2}}" name="ver[{{$key2}}]" value="show {{$permiso['tabla']}}" {{ $permiso['ver'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="eliminar-{{$key2}}" name="eliminar[{{$key2}}]" value="destroy {{$permiso['tabla']}}" {{ $permiso['eliminar'] == 1 ? 'checked' : '' }}>
                    </div>
                    <div class="col-lg-1">
                      <input type="checkbox" class="reportar-{{$key2}}" name="reportar[{{$key2}}]" value="report {{$permiso['tabla']}}" {{ $permiso['reportar'] == 1 ? 'checked' : '' }}>
                    </div>
                  </div>
                @endforeach
              @endif
