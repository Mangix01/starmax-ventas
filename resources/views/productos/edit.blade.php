            ...
            <div class="row">
              <div class="col-lg-6">
             		...
             		<div class="form-group">
  	            	...
  	            	<input type="text" name="codigo" class="form-control" value="{{old('codigo',$producto->codigo)}}" placeholder="{{__('Digite aquí') }} Codigo..." >
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="text" name="nombre" class="form-control" value="{{old('nombre',$producto->nombre)}}" placeholder="{{__('Digite aquí') }} Nombre *..." required>
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="number" name="stock" class="form-control" value="{{old('stock',$producto->stock)}}" placeholder="{{__('Digite aquí') }} Stock *..." required>
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="text" name="marca" class="form-control" value="{{old('marca',$producto->marca)}}" placeholder="{{__('Digite aquí') }} Marca *..." required>
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="text" name="descripcion" class="form-control" value="{{old('descripcion',$producto->descripcion)}}" placeholder="{{__('Digite aquí') }} Descripcion..." >
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="decimal" name="precio" class="form-control" value="{{old('precio',$producto->precio)}}" placeholder="{{__('Digite aquí') }} Precio *..." required>
              ...
              <div class="col-lg-6">
             		<div class="form-group">
  	            	...
  	            	<input type="file" name="imagen" class="form-control" value="{{old('imagen',$producto->imagen)}}" placeholder="{{__('Digite aquí') }} Imagen..." id="imagen" accept="image/*" onchange="colocarFoto('imagen','.img-thumbnail{{$producto->id}}');" >
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <select name="estado" class="form-control"  required>
                        <option @if ($producto->estado == "1") selected @endif value="1">Activo</option><option @if ($producto->estado == "0") selected @endif value="0">Inactivo</option>
                    </select>
                </div>
            </div>
            </div>
