          ...
          <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="number" name="cantidad" id="cantidad" class="form-control" placeholder="cantidad..." min="1" value="1" onchange="validarCantidad(); calcularSubtotal();">
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="decimal" name="precio" id="precio" class="form-control" readonly placeholder="precio..." onchange="calcularSubtotal();">
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="decimal" name="descuento" id="descuento" class="form-control" placeholder="descuento..." min="0" max="100" onchange="validarDescuento(); calcularSubtotal();">
                </div>
            </div>
